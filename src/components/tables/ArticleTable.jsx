...
export default function ArticleTable() {
  ...
  const [createProductModalActive, setCreateProductModalActive] =
    useState(false);
  ...
  const columns = [
    ...
    { field: "name", headerName: "Name", width: 150, editable: true },
    {
      ...
      renderEditCell: (params) =>
        renderSelectCategoryEditInputCell({
          ...params,
    ...
    },
    {
      ...
      editable: true,
      renderEditCell: (params) =>
        renderSelectBrandEditInputCell({ ...params, options: brands }),
      valueGetter: (value, row) => {
        return row.brand;
      },
