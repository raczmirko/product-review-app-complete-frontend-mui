...
const AssignReviewAspectValueModal = ({
  review,
  isOpen,
  setIsOpen,
  createReviewBody,
        ...
        >
          ...
          >
            <Typography variant="h5" component="div" gutterBottom>
              Modify aspect scores for '{review.product.article.name}'
            </Typography>
            <Typography variant="subtitle2" component="div" gutterBottom>
              Click any star to give a score, click again to remove it.
            </Typography>
                ...
                aspects.map((aspect) => (
                  <Box key={aspect.id}>
                    ...
                    <Rating
                      ...
                      value={aspect.score}
                      onChange={(e, newValue) =>
                        handleModification(aspect.id, newValue)
                      }
                    />
                  </Box>
                ))}
