  ...
  return (
    <Box sx={{ width: "100%", justifyContent: "center", textAlign: "center" }}>
      ...
      <Typography
        ...
        sx={{ ml: 10, mr: 10, mb: 2, textAlign: "center" }}
      >
        Example: '4-5' is 75% - This means that 75% of the products of your
        favourite brands have a rating average between 4 and 5.{" "}
      </Typography>
      <PieChart
        series={[
          {
