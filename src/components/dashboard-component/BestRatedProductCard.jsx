    ...
    return (
        isLoaded ? (
            <Box sx={{width: '100%', justifyContent: 'center' }}>
                <Typography variant='h6' sx={{ textAlign: 'center' }}>My top 3 best rated products</Typography>
                <Typography variant='subtitle2' sx={{ mb: 1, textAlign: 'center', opacity: 0.6 }}>(Ties are allowed)</Typography>
